...
sisref= arcpy.CreateSpatialReference_management(r"C:\Users\fgonzalezf\AppData\Roaming\ESRI\Desktop10.2\ArcMap\Coordinate Systems\WGS 1984.prj")
arcpy.CreateFeatureDataset_management(Geodatabase,"APN",sisref)
dataset= Geodatabase+ os.sep+"APN"
#Featuare Class
