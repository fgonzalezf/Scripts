...
carpeta = r"C:\Users\pache\Documents\SGC\Litoteca\Actualizacion_pruebas\Prueba1"
archivoExcel = r"C:\Users\pache\Documents\SGC\Litoteca\Actualizacion_pruebas\Litoteca Datum Bogota Central - Solicitud N° 1.xlsx"
origen = "Colombia Bogota Zone"
geodatabase = r"C:\Users\pache\Documents\SGC\Litoteca\Actualizacion_pruebas\Prueba1\solicitud_2.gdb"
...
if origen != "MAGNA" and origen != "BOGOTA":
        if origen == "Colombia Bogota Zone" or origen == "Colombia E Central Zone"  or origen == "Colombia East Zone" or origen == "Colombia West West Zone"or origen == "Colombia West Zone":
            try:
                ...
                arcpy.AddMessage("Error Creando Layer de Puntos: " )
            try:
...
try:
    ...
    arcpy.AddMessage("Error Cargando Solicitud: " )
...
try:
    ...
    arcpy.AddMessage("Error Cargando puntos: " )

try:
    arcpy.Append_management(in_put, output, "NO_TEST", fieldmapping)
except Exception as e:
    arcpy.AddMessage("Error Cargando información: " )
try:
    ...
    arcpy.AddMessage("Error Calculando Longitud: " )
try:
    ...
    arcpy.AddMessage("Error Calculando Latitud: " )
...
try:
    ...
    arcpy.AddMessage("Error Borrando Temporales: ")
"""
