...
if __name__ == '__main__':
    ...
    Ej="https://webadaptorA.domain.com/arcgis admin pass.word owner:sarah https://webadaptorB.domain.com/arcgis admin password robert /"
    #args = parser.parse_args()
    sourcePortal = "https://ergit.presidencia.gov.co/arcgis"
    sourceAdmin = "adminportal"
    sourcePassword = "Cartografia17"
    query = "owner:adminportal"
    destPortal = "https://ergit.presidencia.gov.co/arcpre"
    destAdmin = "adminportal"
    destPassword = "Cartografia17"
    owner = "adminportal"
    folder = "/"
